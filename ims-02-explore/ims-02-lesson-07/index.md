...
$$Mean difference = mean_Group1 - mean_Group2$$
...
With females as the reference group, $$Mean difference = mean_Male - mean_Female = 14.46 - 12.37 = 2.09 cm$$. You might report this as: The mean elbow diameter among males is 2.09 cm larger than it is for females.

With males as the reference group, $$Mean difference = mean_Female - mean_Male = 12.37 - 14.46 = -2.09 cm$$. You might report this as: The mean elbow diameter among females is 2.09 cm smaller than it is for males.
